...
hl.animation({ leaf = "windowsOut",    enabled = true,  speed = 1.49, bezier = "almostLinear",       style = "gnomed" })
hl.animation({ leaf = "fadeIn",        enabled = true,  speed = 1.73, bezier = "easeInOutCubic" })
hl.animation({ leaf = "fadeOut",       enabled = true,  speed = 1.46, bezier = "easeInOutCubic" })
