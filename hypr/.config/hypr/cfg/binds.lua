...
hl.bind(mainMod .. " + F", function()
	...
	hl.config({
		general = {
			gaps_in = focus_mode and focus.gaps_in or normal.gaps_in,
			gaps_out = focus_mode and focus.gaps_out or normal.gaps_out,
			border_size = focus_mode and focus.border_size or normal.border_size,
		},
		decoration = {
			rounding = focus_mode and focus.rounding or normal.rounding,
		},
	})
